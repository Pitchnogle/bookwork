...
_The code is this exercise is quite long so is not included here._
...
the head putting him down, then jumps through the Weapon
Armory door.
...
the Gothon put their hands up and start to sweat.
