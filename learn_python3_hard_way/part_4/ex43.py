from sys import _current_frames, exit
...
class CentralCorridor(Scene):
    def enter(self):
        print(dedent("""
            ...
            member and your last mission is to get the nuetron destruct
...
class LaserWeaponArmory(Scene):
    def enter(self):
        print(dedent("""
            ...
            quiet, too quiet. You stand up and and run to the far side of
            the room and find the neutron bomb in its container.
            There's a keypad lock on the box and you need the code to
            get the bomb out. If you get the wrong code 10 times then
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            print(dedent("""
                ...
                disarm the bomb. You did knowing they will probably
            ...
            print(dedent("""
                ...
                Gothons can't get out. Now that the bomb it placed
                you run to the escape pod and get off this tin can.
                """))
            return 'escape_pod'
